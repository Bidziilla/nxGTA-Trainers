...
namespace tsl {
    ...
    namespace style {
        ...
        namespace color {
            constexpr u16 ColorFrameBackground  = 0xE000;   ///< Overlay frame background color
            constexpr u16 ColorTransparent      = 0x0000;   ///< Transparent color
            constexpr u16 ColorHighlight        = 0xF790;   ///< Greenish highlight color
            constexpr u16 ColorFrame            = 0xF777;   ///< Outer boarder color
            constexpr u16 ColorHandle           = 0xF555;   ///< Track bar handle color
            constexpr u16 ColorText             = 0xFF99;   ///< Standard text color
